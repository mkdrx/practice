...
const Login = (props) => {
  ...
  // Function I want to be triggered only when array content is changed (dependencies)
  // in this case: sets the form as valid if enteredMail has @ and enteredPassword is higher than 6
  // its reevaluated since enteredEmail and enteredPassword are being changed with key strokes BUT
  // added Timeout so it only validates after stop typing for 500ms and not on every single key stroke
